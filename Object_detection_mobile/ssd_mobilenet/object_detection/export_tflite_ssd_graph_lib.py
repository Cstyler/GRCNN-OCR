...
from object_detection.builders import graph_rewriter_builder, model_builder, post_processing_builder
...
def export_tflite_graph(pipeline_config,
                        ...
                        detections_per_class=100,
                        use_regular_nms=False,
                        binary_graph_name='saved_model.pb',
                        txt_graph_name='saved_model.pbtxt',
                        additional_output_tensors=(),
                        optimize=False):
    ...
    Args:
      ...
      optimize: bool, optimize inference or not.
    ...
    if optimize:
        transformed_graph_def = optimize_for_inference_lib.optimize_for_inference(
            ...
            ["normalized_input_image_tensor"],  # an array of the input node(s)
            ["TFLite_Detection_PostProcess"],  # an array of output nodes
