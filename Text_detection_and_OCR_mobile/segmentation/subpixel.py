...
def icnr_weights(init=tf.compat.v1.glorot_normal_initializer(), scale=2, shape=(3, 3,
                                                                                32, 4),
                 dtype=tf.float32):
...
class ICNR:
    ...
    def __call__(self, shape, dtype, partition_info=None):
        ...
        x = tf.compat.v1.image.resize_nearest_neighbor(x, size)
...
class Subpixel(Conv2D):
    ...
    def _phase_shift(self, I):
        ...
        X = K.reshape(I,
                      [bsize, a, b, int(c / (r * r)), r, r])  # bsize, a, b, c/(r*r), r, r
